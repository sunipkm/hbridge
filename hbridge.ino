...
//  digitalWrite(SS, HIGH);
  ...
  x.hben1 = 1 ;
  x.hben2 = 1 ;
  Serial.print("Cmd: ");Serial.println(x.cmd);
  y.data = SPI.transfer16(x.cmd);
  Serial.print("Init: "); Serial.println(y.data);
  delay(1000);
}
void loop() {
    short res ;
    ...
    x.hbcnf2 = 0;
    y.data=SPI.transfer16(x.cmd);
    Serial.print("On: ");Serial.println(y.data);
    delay(1000);
    x.hbcnf3 = 0;
    x.hbcnf4 = 1;
    x.hbcnf1 = 0;
    x.hbcnf2 = 1;
    y.data=SPI.transfer16(x.cmd);
    Serial.print("Off: ");Serial.println(y.data);
    delay(1000);
